"""
Create admin user using direct SQL insertion.
This bypasses Python password hashing issues.
Run via Railway CLI: railway run python create_admin_sql.py
"""
...
try:
    ...
    print("  Creating Admin User (SQL Direct Method)", file=sys.stderr)
    print("=" * 60, file=sys.stderr)
    ...
    try:
        ...
        print("   Hashing password with bcrypt...", file=sys.stderr)
